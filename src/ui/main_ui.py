...
from services import message_handeler, chat_handeler
...
def main(page: ft.Page) -> None:
    ...
    def on_message(message: Message) -> None:
        ...
        if message.message_type == "login_message":
            ...
            match command_args[0]:
                ...
                case "/clear":
                    chat_list.clear_chat(message.chat)
            ...
            m = message_handeler.send_message(message)
    ...
    chat_list = chat_handeler.ChatList()
    ...
    chat_list_row = ft.Column([
            chat_list_control if verify_admin(page.session.get("user_name")) else ft.Text("TeenyChat"),
            chat_list_container
        ],
        expand=True
    )
